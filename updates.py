...
@click.command()
@click.argument('repos', nargs=-1)#, help='Repos to consider. Accepts the following formats: library/ubuntu:latest, ubuntu:latest, ubuntu')
@click.option('--years', '-y', default=1)#, help='Number of years (from this one) to look back.')
@click.option('--output', '-o', default='results.png')
